...
#define BUTTON_AREA_TOP 169
#define BUTTON_AREA_BOT 240//209
...
#define TOUCHABLE_Y_HEIGHT 157
//#define TOUCHABLE_X_WIDTH  SCREEN_WIDTH
#define TOUCHABLE_X_WIDTH 320
...
uint8_t XPT2046::read_buttons() {
    ...
    !WITHIN(y, SCREEN_START_TOP, SCREEN_START_TOP + SCREEN_HEIGHT)) return 0;
